...
public interface UserMapper {
    ...
    long countByConditions(@Param("role") String role, @Param("status") String status);
    ...
    List<User> findByConditions(@Param("role") String role, @Param("status") String status,
                               @Param("parentId") Long parentId, @Param("offset") int offset, @Param("limit") int limit);
}